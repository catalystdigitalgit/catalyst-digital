      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <NavLink to="/resources" className="text-muted-foreground hover:text-primary transition-colors">
                  Resources
                </NavLink>
              </li>
              <li>
                <NavLink to="/case-studies" className="text-muted-foreground hover:text-primary transition-colors">
                  Case Studies
                </NavLink>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <NavLink to="/press" className="text-muted-foreground hover:text-primary transition-colors">
                  Press
                </NavLink>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              />
              <Button variant="high" size="sm" tooltip="Subscribe to newsletter" leftIcon={<Mail className="h-4 w-4" />}>
                Subscribe
              </Button>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="flex space-x-4 text-sm text-muted-foreground">
            ...
            <NavLink to="/cookies" className="hover:text-primary transition-colors">
              Cookie Policy
            </NavLink>
          </div>
        </div>
